...
CLIENT = ZhipuAI(api_key="b5096e8a6e349a23a21133913debcb66.OqgudngkdbwyASB2") # 我的 剩约800W
CLIENT2 = ZhipuAI(api_key="26a3b41c3a7ca14bad225bedeb9b8798.kyEWZa33ZjDKywsa") # cx 500W
CLIENT3 = ZhipuAI(api_key="387e1cb8c729b9e7abc7a4d19657957c.bGZbGb2Lgkujfjpl")
...
for file in os.listdir(DIR_NAME):
    ...
    prompt = open(f"{DIR_NAME}/{file}").read().strip().lstrip()
